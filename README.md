...
<div align="center"><img style="background: white;" src="https://render.githubusercontent.com/render/math?math=%5Clambda"></div>
 \
...
where:
<!-- $$
F_{j}(I_{i})(x,y) \text{ - is the j-th channel of the feature-map for the image.}
$$ --> 

<div align="center"><img style="background: white;" src="https://render.githubusercontent.com/render/math?math=F_%7Bj%7D(I_%7Bi%7D)(x%2Cy)%20%5Ctext%7B%20-%20is%20the%20j-th%20channel%20of%20the%20feature-map%20for%20the%20image.%7D"></div>
 \
